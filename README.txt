...
At the beginning of each turn, every player independently designates a card to be discarded. When all players have picked a card, the cards are placed on the stacks. The player whose card has the smallest face value goes first, followed by the player with the card with the second smallest face value, and so on.
...
The round is over when all players have discard all their cards and placed them on the stacks according to the above procedure.
